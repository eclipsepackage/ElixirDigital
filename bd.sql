...
-- Feedbacks
INSERT INTO feedback (mensagem, origem_cliente, autor, fk_cliente, fk_administrador) VALUES
('Excelente serviço, muito satisfeito!', TRUE, 'Ana Souza', 1, NULL),
('Projeto entregue com qualidade, recomendo!', TRUE, 'João Pereira', 2, NULL),
('Feedback interno cadastrado pelo admin', FALSE, 'Vinicius Aquino', NULL, 1);
